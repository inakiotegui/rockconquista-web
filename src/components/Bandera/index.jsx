...
export default function Bandera() {
  ...
  return (
    <section className="bandera" id="tienda">
      <div className="bandera__left">
        <h2
          ref={titleRef}
          className={`bandera__title ${
            titleVisible ? 'bandera__title--visible' : ''
          }`}
        >
          LA MÚSICA
          <br />
      ...
      <div className="bandera__right">
        <div
          ref={buttonsRef}
          className={`bandera__buttons ${
            buttonsVisible ? 'bandera__buttons--visible' : ''
          }`}
        >
          <div
            className="bandera__button"
            onClick={openModal}
            role="button"
            tabIndex={0}
          ...
          >
            <img
              className="bandera__icon"
              src={icon1}
              alt="icono merch oficial"
            />
            <img
              src={imgShop}
              alt="Botón Merch Oficial"
              className="bandera__img"
            />
            <div className="bandera__label">
              MERCH
              <br />
              OFICIAL
            </div>
          ...
          <div
            ...
            role="button"
            tabIndex={0}
            onKeyPress={(e) => e.key === 'Enter' && scrollToNovedades()}
          >
            <img
              className="bandera__icon"
              src={icon2}
              alt="icono últimas novedades"
            />
            <img
              src={imgNews}
              alt="Botón Últimas Novedades"
              className="bandera__img"
            />
            <div className="bandera__label">
              ÚLTIMAS
      ...
      {modalOpen && (
        <div className="bandera__modal-overlay" onClick={closeModal}>
          ...
          >
            <button
              className="bandera__modal-close"
              onClick={closeModal}
            ...
            <h3 id="modal-title" className="bandera__modal-title">
