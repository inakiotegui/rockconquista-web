  ...
  return (
    <section className="newsletter" id="newsletter">
      <div className="newsletter-banner">
        <div
          ref={containerRef}
          className={`newsletter-banner__text ${
            showAnimation ? 'animate' : ''
          }`}
        >
          <h2 className="newsletter-banner__title">Newsletter</h2>
          <p className="newsletter-banner__subtitle">
            Enterate antes que nadie de todas las novedades
          </p>
        </div>
        <form
          className={`newsletter-banner__form ${showAnimation ? 'animate' : ''}`}
        ...
        >
          ...
          <button
            type="submit"
            className="newsletter-banner__button"
            aria-label="Enviar"
          >
            <FaPaperPlane />
          </button>
